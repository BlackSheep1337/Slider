      ...
      <AppBar>
        <Toolbar className={classes.navbar}>
          <Typography variant="h4">
            ...
            <a rel="noreferrer" target="_blank" href="https://www.linkedin.com/in/alexandre-pereira-0aba82205/">
              <LinkedInIcon className={classes.in} />
            </a>
            <a rel="noreferrer" target="_blank" href="https://github.com/Naitwa-Alexandre">
